...
* `batch1` (this folder contains all the CSVs for a specific batch, always one `works.csv` file and a CSV for each manuscript with page rows only.)
    ...
    * `hathaway1.csv` (this csv contains all **Page** rows for a given mss in `works.csv`)
    * `hathaway2.csv` (this csv contains all **Page** rows for a given mss in `works.csv`)
    * `hathaway3.csv` (this csv contains all **Page** rows for a given mss in `works.csv`)
    * `hathaway4.csv` (this csv contains all **Page** rows for a given mss in `works.csv`)
